...
export const PRESET_THEMES: Theme[] = [
  {
    ...
    locations: [
      ...
      { name: 'Fern Forest', levelRange: [6, 11], icon: '🌿', storyHook: 'Tall ferns part before you as you stomp deeper in. 🌿' },
      { name: 'Lava Plateau', levelRange: [12, 16], icon: '🌋', storyHook: 'The volcano rumbles — your dinosaur roars right back! 🌋' },
      { name: 'Dino Peak', levelRange: [17, 21], icon: '⛰️', storyHook: 'You stand at the peak of the world. All dinosaurs cheer! ⛰️' },
    ],
    evolutionStages: ['🥚', '🦎', '🦕', '🦖'],
  ...
  },
  {
    ...
    locations: [
      ...
      { name: 'Asteroid Belt', levelRange: [6, 11], icon: '☄️', storyHook: 'You loop through the asteroids without a scratch! ☄️' },
      { name: 'Nebula Drift', levelRange: [12, 16], icon: '🌌', storyHook: 'Colours pour past the windows — you\'re deep in space! 🌌' },
      { name: 'Starfall Station', levelRange: [17, 21], icon: '🌟', storyHook: 'The whole galaxy sparkles around you. You made it! 🌟' },
    ],
    evolutionStages: ['🌑', '🛸', '🚀', '🌟'],
  ...
  },
  {
    ...
    locations: [
      ...
      { name: 'Coral Kingdom', levelRange: [6, 11], icon: '🪸', storyHook: 'Coral towers stretch up like a colourful underwater city! 🪸' },
      { name: 'Midnight Trench', levelRange: [12, 16], icon: '🌊', storyHook: 'It\'s dark and glittery and magical down here! 🌊' },
      { name: 'Pearl Grotto', levelRange: [17, 21], icon: '🐚', storyHook: 'You find the pearl the ocean has been hiding! 🐚' },
    ],
    evolutionStages: ['🥚', '🐟', '🐬', '🐋'],
  ...
  },
  {
    ...
    locations: [
      ...
      { name: 'Treetop Village', levelRange: [6, 11], icon: '🌳', storyHook: 'You leap into the treetops and can see for miles! 🌳' },
      { name: 'Mist Valley', levelRange: [12, 16], icon: '🌿', storyHook: 'Mist swirls around giant leaves as you push forward! 🌿' },
      { name: 'Golden Canopy', levelRange: [17, 21], icon: '✨', storyHook: 'You burst through the canopy into golden sunlight! ✨' },
    ],
    evolutionStages: ['🌱', '🐒', '🦍', '🌴'],
  ...
  },
  {
    ...
    locations: [
      ...
      { name: 'Rainbow Bridge', levelRange: [6, 11], icon: '🌈', storyHook: 'You gallop across the rainbow, hooves sparkling! 🌈' },
      { name: 'Crystal Cavern', levelRange: [12, 16], icon: '💎', storyHook: 'Crystals hum with ancient unicorn magic all around you! 💎' },
      { name: 'Moonrise Summit', levelRange: [17, 21], icon: '🌙', storyHook: 'A moonbeam crowns your horn. You are legendary! 🌙' },
    ],
    evolutionStages: ['⭐', '🌸', '🦄', '🌈'],
  ...
  },
  {
    ...
    locations: [
      ...
      { name: 'Circuit City', levelRange: [6, 11], icon: '🔌', storyHook: 'A million lights blink in perfect patterns! 🔌' },
      { name: 'Code Sector', levelRange: [12, 16], icon: '💻', storyHook: 'Processing power: MAXIMUM. You can do anything! 💻' },
      { name: 'Mainframe Core', levelRange: [17, 21], icon: '🤖', storyHook: 'CORE UNLOCKED. You are the greatest robot ever built! 🤖' },
    ],
    evolutionStages: ['🔩', '⚙️', '🤖', '🦾'],
  ...
  },
  {
    ...
    locations: [
      ...
      { name: 'Garden Rooftop', levelRange: [6, 11], icon: '🏡', storyHook: 'You leap from roof to roof without looking down! 🏡' },
      { name: 'Night Alley', levelRange: [12, 16], icon: '🌙', storyHook: 'The night belongs to you. Every shadow is yours! 🌙' },
      { name: 'Ancient Tower', levelRange: [17, 21], icon: '🗼', storyHook: 'You claim the tower! Cats will tell of this day! 🗼' },
    ],
    evolutionStages: ['🐾', '🐱', '😺', '👑'],
