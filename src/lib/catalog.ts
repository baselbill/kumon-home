...
export const ITEM_CATALOG: CatalogItem[] = [
  ...
  { id: 'dino_rock',       name: 'Boulder',      emoji: '🪨', price:  9, themeKey: 'dinosaurs', tier: 'common' },
  { id: 'dino_swamp',      name: 'Swamp Plant',  emoji: '🌱', price: 10, themeKey: 'dinosaurs', tier: 'common' },
  ...
  { id: 'dino_nest',       name: 'Dino Nest',    emoji: '🪶', price: 25, themeKey: 'dinosaurs', tier: 'uncommon' },
  ...
  { id: 'dino_volcano_big',name: 'Giant Volcano',emoji: '🌋', price: 50, themeKey: 'dinosaurs', tier: 'rare' },
  ...
  { id: 'space_asteroid',   name: 'Asteroid',       emoji: '🌑', price: 10, themeKey: 'space', tier: 'common' },
  { id: 'space_star',       name: 'Shooting Star',  emoji: '⭐', price:  9, themeKey: 'space', tier: 'common' },
  ...
  { id: 'space_rocket',     name: 'Rocket Ship',    emoji: '🛸', price: 24, themeKey: 'space', tier: 'uncommon' },
  ...
  { id: 'space_wormhole',   name: 'Wormhole',       emoji: '🌀', price: 50, themeKey: 'space', tier: 'rare' },
  ...
  { id: 'ocean_sea_urchin',  name: 'Sea Urchin',     emoji: '🌊', price:  9, themeKey: 'ocean', tier: 'common' },
  { id: 'ocean_octopus',     name: 'Octopus',        emoji: '🐙', price: 10, themeKey: 'ocean', tier: 'common' },
  ...
  { id: 'ocean_seahorse',    name: 'Seahorse',       emoji: '🐴', price: 20, themeKey: 'ocean', tier: 'uncommon' },
  ...
  { id: 'ocean_kraken',      name: 'Kraken',         emoji: '🦑', price: 50, themeKey: 'ocean', tier: 'rare' },
  ...
  { id: 'jungle_snake',       name: 'Snake',         emoji: '🐍', price:  9, themeKey: 'jungle', tier: 'common' },
  { id: 'jungle_cocoa',       name: 'Cocoa Pod',     emoji: '🫘', price: 10, themeKey: 'jungle', tier: 'common' },
  ...
  { id: 'jungle_vines',       name: 'Vine Swing',    emoji: '🌿', price: 24, themeKey: 'jungle', tier: 'uncommon' },
  ...
  { id: 'jungle_lost_temple', name: 'Lost Temple',   emoji: '🏛️', price: 50, themeKey: 'jungle', tier: 'rare' },
  ...
  { id: 'uni_heart',       name: 'Magic Heart',   emoji: '💖', price: 10, themeKey: 'unicorns', tier: 'common' },
  { id: 'uni_sparkle',     name: 'Sparkles',      emoji: '✨', price:  9, themeKey: 'unicorns', tier: 'common' },
  ...
  { id: 'uni_castle',      name: 'Cloud Castle',  emoji: '🏰', price: 25, themeKey: 'unicorns', tier: 'uncommon' },
  ...
  { id: 'uni_throne',      name: 'Magic Throne',  emoji: '👑', price: 50, themeKey: 'unicorns', tier: 'rare' },
  ...
  { id: 'robot_chip',      name: 'Microchip',     emoji: '🟦', price:  9, themeKey: 'robots', tier: 'common' },
  { id: 'robot_plug',      name: 'Power Plug',    emoji: '🔌', price: 10, themeKey: 'robots', tier: 'common' },
  ...
  { id: 'robot_computer',  name: 'Computer',      emoji: '💻', price: 25, themeKey: 'robots', tier: 'uncommon' },
  ...
  { id: 'robot_mainframe', name: 'Mainframe',     emoji: '🖥️', price: 50, themeKey: 'robots', tier: 'rare' },
  ...
  { id: 'cat_plant',       name: 'House Plant',   emoji: '🪴', price:  9, themeKey: 'cats', tier: 'common' },
  { id: 'cat_butterfly',   name: 'Butterfly',     emoji: '🦋', price: 10, themeKey: 'cats', tier: 'common' },
  ...
  { id: 'cat_food',        name: 'Food Bowl',     emoji: '🍖', price: 23, themeKey: 'cats', tier: 'uncommon' },
  ...
  { id: 'cat_kingdom',     name: 'Cat Kingdom',   emoji: '🏯', price: 50, themeKey: 'cats', tier: 'rare' },
]
